                        ...
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="w-full mb-10">
                                ...
                                <p className="text-base text-body-color">
                                    GDI Tiles: Queensland's premier tile supplier, blending affordability with top-notch quality for residential and commercial projects. Experience our minimalist approach to transform your tile shopping into an effortless journey.
                                    Join us in reshaping interiors with elegance and functionality, leaving a lasting mark of sophistication.
                                </p>
                            </div>
                        </div>
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="w-full mb-10">
                                <h4 className="text-lg font-semibold mb-9 text-dark"> Address </h4>
                                <p className="text-base mb-2 text-body-color">
                                    267B Elizabeth Avenue, Clontarf QLD 4019.
                                </p>
                                <p className="text-base mb-2 text-body-color">
                                    332 Shakespeare Street, Mackay QLD 4740.
                                </p>
                                <p className="flex items-center text-sm font-medium text-dark">
                                    ...
                                    <span>0478075300, 0432804546, 0413108909, 0401518487</span>
                                </p>
                            </div>
                        </div>
                        <LinkGroup header="Quick Links">
                            <NavLink link="/" label="Home" />
                            <NavLink link="/products/All" label="All products" />
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="w-full mb-10">
                                ...
                                <div className="flex items-center mb-6">
                                    <a
                                        href="https://www.facebook.com/premiumtilespremiumlook"
                                        target="_blank"
                                        className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark  hover:bg-[#FF6600] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width={8}
                                            height={16}
                                    ...
                                    <a
                                        ...
                                        className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:bg-[#FF6600] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <rect width="20" height="20" x="2" y="2" rx="5" ry="5" />
                                            <path d="M16 11.37A4.32 4.32 0 0 1 12 15a4.32 4.32 0 0 1-4-3.63A4.29 4.29 0 0 1 12 8a4.29 4.29 0 0 1 4 3.37z" />
                                ...
                                <p className="text-base text-body-color">
                                    {" "}
                                    © {new Date().getFullYear()} Gdi Tiles{" "}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <defs>
                                <linearGradient
                                    ...
                                    gradientUnits="userSpaceOnUse"
                                >
                                    <stop stopColor="#FF6600" stopOpacity="0.31" />
                                    <stop offset={1} stopColor="#C4C4C4" stopOpacity={0} />
                                </linearGradient>
                            </defs>
                        </svg>
    ...
    return (
        <div>
            <li>
                <Link
                    href={link}
                    className={`inline-block mb-2 text-base leading-loose text-body-color hover:text-[#FF6600]`}
                >
                    {label}
                </Link>
            </li>
