...
const Contact = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      let response = await fetch("/api/sendmail", {
        method: "POST",
        body: JSON.stringify({ name, email, phoneNumber, details }),
      });
      if (response.ok) {
  ...
  const variantSlideUp = slideInfromBottom("0.2")
  const variantSlideUp2 = slideInfromBottom("0.3")
  const variantSlideUp3 = slideInfromBottom("0.3")
  const variantSlideUp4 = slideInfromBottom("0.4")
  const zoomIn = {
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <AnimatedElement animationProperties={variantSlideUp}>
                  <span className="block mb-4 text-base font-semibold text_orange">
                    Contact Us
                  </span>
                </AnimatedElement>
                <AnimatedElement animationProperties={variantSlideUp2}>
                  <h2 className="mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                    GET IN TOUCH WITH US
                  </h2>
                </AnimatedElement>
                <AnimatedElement animationProperties={variantSlideUp3}>
                  <p className="text-base leading-relaxed mb-9 text-body-color">
                    For personalized assistance and to discuss your unique project requirements, reach out to us. Let's collaborate to bring a touch of elegance to your
                    spaces – your journey to exceptional design starts by getting in touch with GDI Tiles.
                  </p>
                </AnimatedElement>
                <AnimatedElement animationProperties={variantSlideUp4}>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-base text-body-color">
                        267B Elizabeth Avenue,
                        Clontarf QLD 4019.
                      </p>
                      <p className="text-base text-body-color mt-1">
                        332 Shakespeare Street,
                        Mackay QLD 4740.
                      </p>
                    </div>
                  </div>
                ...
                <AnimatedElement animationProperties={variantSlideUp4}>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-base text-body-color">
                        0478075300, 0432804546, 0413108909, 0401518487
                      </p>
                    </div>
                  </div>
                </AnimatedElement>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <AnimatedElement animationProperties={zoomIn}>
                <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                  <form onSubmit={handleFormSubmit}>
                    ...
                    />
                    <div>
                      {emailError && <p className="text-red-500 m-1 text-center text-base opacity-100 transition-opacity duration-500">{emailError}</p>}
                      <Button
                        type="submit"
                        className="w-full p-3 text-white transition border bg-orange rounded hover:bg-opacity-90"
                      >
                        Send Message
                      </Button>
                    </div>
...
const ContactInputBox = ({ type, placeholder, name, isError }) => {
  const inputStyle = `border ${isError ? 'border-red-500 text-red-500' : 'border-[f0f0f0] text-body-color'} w-full rounded border py-3 px-[14px] text-base outline-none focus: focus-visible:shadow-none`;
  return (
    <>
      <div className="mb-6">
        <input
